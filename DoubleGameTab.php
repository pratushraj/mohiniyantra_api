<div id="doubleGame" class="tab-pane fade show " role="tabpanel" aria-labelledby="doubleGame-tab">
    ...
    <div class="btn-group w-100 cont">
            ...
            <button type="button" class="btn btn-bulk1  doubleGame-sub-tab prev_game_res_rr" id="">RR51 || 14:30</button>
            <button type="button" class="btn btn-bulk1  doubleGame-sub-tab prev_game_res_ry" id="">RY97 || 14:30</button>
        ...
        <div class="btn-group w-100 nav " role="tablist">
            <button type="button" class="btn btn-bulk active nav-link doubleGame-sub-tab" id="nv-sub-tab" data-bs-toggle="tab" data-bs-target="#nv-sub-game" role="tab" aria-controls="nv-sub-game" aria-selected="true">RM</button>
